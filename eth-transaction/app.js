...
app.get('/send-transaction', (req, res) => {
  ...
  if (req.query.type === "erc20"){
    ...
    console.log(" ===================  erc20 transaction send ");
    var Tx = require("ethereumjs-tx").Transaction;

    var myAddress = req.query.from_address;
    var toAddress = req.query.to_address;
    var amount2 = req.query.amount;



    var tokens = web3.utils.toWei(amount2.toString(), 'ether')
    var amount = web3.utils.toBN(tokens)
    ...
    console.log(" myaddress, toaddress, amount, contract    ", myAddress, "   ", toAddress, "    ", amount,"    ", erc20_contract_address);
    console.log("private key   ", req.query.privateKey);
    ...
    .then(function (testresponse){
      console.log(" ====== test the balance response    ", testresponse.data);
      ...
      axios(config)
        .then(function (response) {
          ...
          var privateKey = Buffer.from(req.query.privateKey.substring(2, privateKey.length), 'hex');
  ...
  if (req.query.type === "ethereum"){
    ...
    console.log(" ===================  ethereum transaction send ");
